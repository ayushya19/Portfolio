  ...
  projects: [
    {
      ...
      image: '/assets/portfolio/mahavitran.png',
      gallery: [
        '/assets/portfolio/mahavitran.png',
        '/assets/portfolio/electricity-maintenance.png',
        '/assets/portfolio/motion-capture-suit.png',
      ],
      accent: '#f59e0b',
    ...
    },
    {
      ...
      image: '/assets/portfolio/human-pose-reconstruction.png',
      gallery: [
        '/assets/portfolio/human-pose-reconstruction.png',
        '/assets/portfolio/pipeline.png',
        '/assets/portfolio/pose-reconstruction.png',
        '/assets/portfolio/statistics.png',
      ],
      accent: '#14b8a6',
    ...
    },
    {
      ...
      image: '/assets/portfolio/manav.png',
      gallery: [
        '/assets/portfolio/manav.png',
        '/assets/portfolio/metahuman.png',
        '/assets/portfolio/lip-syncing.png',
        '/assets/portfolio/unreal-engine.png',
      ],
      accent: '#ec4899',
    ...
    },
    {
      ...
      image: '/assets/portfolio/schrodingers-cat.png',
      gallery: [
        '/assets/portfolio/schrodingers-cat.png',
        '/assets/portfolio/live-quantum-circuit.png',
        '/assets/portfolio/schrodingers-equation.png',
      ],
      accent: '#8b5cf6',
